          ...
          <div className="row mt-4">
            <div className="col-lg-3">
              <div className="m-1 p-5 border">
                <i className="mdi mdi-center-focus-weak mdi-4x" />
                <h6>FOCUS</h6>
                <p>On what matters</p>
              </div>
            </div>
            <div className="col-lg-3">
              <div className="m-1 p-5 border">
                <i className="mdi mdi-slideshow mdi-4x" />
                <h6>SHOW</h6>
            ...
            <div className="col-lg-3">
              <div className="m-1 p-5 border">
                <i className="mdi mdi-access-time mdi-4x" />
                <h6>TIME</h6>
            ...
            <div className="col-lg-3">
              <div className="m-1 p-5 border">
                <i className="mdi mdi-timeline mdi-4x" />
                <h6>SHINE</h6>
                <p>Be the one</p>
              </div>
            </div>
